...
public class MysqlGenerator {
     ...
     * 包所在路径
     */
    private static final String  packagePath="com.example.springboot";
    /**
     * 实体所在的module
     */
     ...
     * 数据库表名，支持多个，用,隔开
     */
    private static final String bean="dictype";
    /**
     * 数据库
     */
     ...
     * 作者
     */
    private static final String authorname="guoxiaofeng";
